...
Although it is difficult to quantify the impact of work alone on personal identity, self-esteem and social recognition, most mental health professionals agree that the workplace environment can have a significant impact on an individual’s mental well-being. The impact of mental health problems in the workplace has serious consequences not only for the individual but also for the productivity of the enterprise. Employee performance, rates of illness, absenteeism, accidents and staff turnover are all affected by employees’ mental health status.
"""
)
